...
def character_rules(character_knight, character_knave):
    return And(
        # Character must be either Knight or Knave
        Or(character_knight, character_knave),
        # Character cannot be both Knight and Knave
        Not(And(character_knight, character_knave))
    )
